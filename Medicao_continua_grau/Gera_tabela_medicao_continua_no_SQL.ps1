...
else
{
    ...
    else
    {
        ...
        do
        {
            ...
            $query = 'exec SP_GERA_TABELA_MEDICAO_CONTINUA ' + $filial
            Write-Host $query
            ...
            #
            # Como as tabelas do Access sao atualizadas somente no final da descarga, nao tem necessidade de releituras tao frequentes
